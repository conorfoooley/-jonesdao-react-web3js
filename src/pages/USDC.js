...
import usdcImg from '../style/images/usdc.webp';
            ...
            <>
                <div class="grid grid-rows-2 token-input-div mt-3 gap-1 rounded border px-2 py-2 border-gray-200" style={{height: "84px",opacity: 0.4}}>
                    ...
                    <div className="d-flex gap-2 aura-img-div">
                        <img src={usdcImg} alt="" className="aura-img"/>
                        <div className="fs-6 fw-bolder pb-5px">USDC</div>
                    </div>
            ...
            <>
                ...
                {withDrawalFlag?
                    <div style={{paddingLeft: '1.25rem',marginLeft: '1.25rem', borderLeft:'1px solid white'}}>
                        <div class="grid grid-rows-2 token-input-div gap-1 rounded border px-2 py-2 border-gray-200" style={{height: "84px",opacity: 0.4}}>
                            <input class="h-50 token-input" placeholder="0.00" value="">
                            </input>
                            <div className="d-flex gap-2 aura-img-div">
                                <img src={jusdcImg} alt="" className="aura-img"/>
                                <div className="fs-6 fw-bolder pb-5px">jUSDC</div>
                            </div>
                            <div className="d-flex gap-2 mt-2 justify-content-end">
                                <div className="fs-5-custom fw-bold text-white-50">Balance: 0.00</div>
                                <div className="balance-btn-div d-flex gap-1 align-items-center fs-5-custom">
            ...
            <Container>
                <Row className="mt-4">
                    <Col lg={12} md={12} sm={12} xs={12} className="d-flex gap-3 align-items-center justify-content-start">
                        ...
                        <img src={jusdcImg} alt="" className="auraImg"/>
                        <h1>Gamma Neutral USDC Vault</h1>
                    </Col>
                </Row>
                <Row className="mt-3">
                    <Col lg={12} md={12} sm={12} xs={12}>
                        <div className="card p-4 d-flex flex-column justify-content-center shadow-sm bg-dark-custom">
                            <div className="fs-4 fw-bolder">$11,079,208</div>
